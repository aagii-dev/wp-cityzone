...
if (!class_exists('vc_odProductItem') && class_exists('WPBakeryShortCode')) {
	class vc_odProductItem extends WPBakeryShortCode
	{
		public function __construct()
		{	
			// ✅ vc_before_init ашиглана!
			add_action('vc_before_init', [$this, 'vc_odProductItem_mapping']);
			// ✅ Shortcode ажиллуулах
			add_shortcode('vc_odProductItem', [$this, 'vc_odProductItem_html']);
		}

		public function vc_odProductItem_mapping()
		{
			vc_map([
				'name' => __('Product item', 'text-domain'),
				'base' => 'vc_odProductItem',
		...
		public function vc_odProductItem_html($atts)
		{
			extract(shortcode_atts([
				'mg_background' => '',
				'mg_title' => '',
				'mg_tag' => '',
				'mg_text_readmore_url' => '',
			], $atts));
			...
			$tag = $mg_tag;
			// vc_link
			$mg_text_readmore_url = $mg_text_readmore_url;
