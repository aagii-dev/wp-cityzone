...
if (!class_exists('vc_odCareerJoin') && class_exists('WPBakeryShortCode')) {
	class vc_odCareerJoin extends WPBakeryShortCode
	{
		public function __construct()
		{	
			// ✅ vc_before_init ашиглана!
			add_action('vc_before_init', [$this, 'vc_odCareerJoin_mapping']);
			// ✅ Shortcode ажиллуулах
			add_shortcode('vc_odCareerJoin', [$this, 'vc_odCareerJoin_html']);
		}

		public function vc_odCareerJoin_mapping()
		{
			vc_map([
				'name' => __('Career join', 'text-domain'),
				'base' => 'vc_odCareerJoin',
		...
		public function vc_odCareerJoin_html($atts)
		{
			...
			foreach ($mg_list as $val) {
				...
				if($mg_video){
					$video_html = "<video class='video-cover' autoplay muted loop playsinline preload='auto'>
									...
									<source src='$mg_video' type='video/webm' />
									...
									<div class='product-item-info'>
										<div id='anchor$rand'>
											<div class='d-flex justify-content-between mb-24' data-aos='fade-up' data-aos-duration='1500' data-aos-delay='100'>
												<div class='product-item-tag fs-24'>$tag</div>
											</div>
